...
% =======================================================
%  MACROS & CONFIGURATION GLOBALE - MATHÉMATIQUES
% =======================================================
...
\usepackage[T1]{fontenc}              % Encodage font
...
\usepackage{slashed}                  % Slash notation (\slashed)
\usepackage{float}                    % Pour le placement des tableaux
\usepackage[version=4]{mhchem}        % Chimie (\ce{})
\usepackage{titlesec}                 % Sections supplémentaires
\usepackage{tikz}                     % Graphiques
\usepackage[compat=1.1.0]{tikz-feynman} % Diagrammes de Feynman
\usetikzlibrary{decorations.markings,angles,quotes} % Tikz extensions
...
\usepackage{esint}       % pour \oiint

% ---------------------------
% CONFIGURATIONS DIVERSES
% ---------------------------
% Supprimer les warnings LuaTeX pour tikz-feynman
\makeatletter
\pgfkeys{
...
\tikzfeynmanset{every photon/.style={thick, color=yellow!90!black}}

% Silence warnings de police
\usepackage{silence}
...
% ---------------------------
% NUMÉROTATION ET STRUCTURE DES SECTIONS
% ---------------------------
...
% =======================================================
% ENSEMBLES ET SYMBOLES MATHÉMATIQUES
% =======================================================
...
\DeclareMathOperator{\tr}{Tr} \DeclareMathOperator{\Sp}{Sp}
\DeclareMathOperator{\divg}{div}
\DeclareMathOperator{\rot}{rot} \DeclareMathOperator{\Ker}{Ker}
\DeclareMathOperator{\cov}{Cov} \DeclareMathOperator{\RC}{RC}
\DeclareMathOperator{\Jac}{Jac} \DeclareMathOperator{\Mat}{Mat}
\DeclareMathOperator{\D}{D} \DeclareMathOperator{\Hess}{Hess}
\DeclareMathOperator{\diag}{diag}
\DeclareMathOperator{\Vect}{Vect}

% Fonctions usuelles et inverses
...
\newcommand{\qv}[4]{\begin{pmatrix} #1 \\ #2 \\ #3 \\ #4 \end{pmatrix}}
\newcommand{\BC}{\text{BC}}
\newcommand{\fami}[2]{\left({#1}_1,\dots,{#1}_{#2}\right)}
\newcommand{\id}{\mathbbm 1}
\newcommand{\GL}{\text{GL}}
\newcommand{\Pass}[2]{\text{Pass}_{#1\gets#2}}
